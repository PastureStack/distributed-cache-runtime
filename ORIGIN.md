...
This repository is derived from the public [Hazelcast repository](https://github.com/hazelcast/hazelcast).
...
- Maintained artifact: PastureStack Maven artifact 5.7.3-pasturestack.4 (numeric Hazelcast cluster runtime 5.7.3), based on Hazelcast 5.7.0, with reviewed source and dependency security updates
...
See [SECURITY-MAINTENANCE.md](SECURITY-MAINTENANCE.md) for the exact maintained delta and verification requirements.
