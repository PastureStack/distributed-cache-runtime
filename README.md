# PastureStack Distributed Cache Runtime
...
The maintained runtime keeps the upstream 5.7.0 API and applies a reviewed set of security updates to shaded runtime libraries and build-time integration dependencies required by PastureStack. See [ORIGIN.md](ORIGIN.md) for provenance and [SECURITY-MAINTENANCE.md](SECURITY-MAINTENANCE.md) for the exact delta and release gates. The original upstream README follows unchanged below.
